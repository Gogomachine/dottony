 ...
 *
 * Все сорок восемь нарисованы для прибора: смайлы, стоявшие тут до них,
 ...
 *
 * Порядок — восемь наборов по шесть: стихии и небо, вещи и ещё вещи,
 * нечисть и ещё нечисть, милые и ещё милые. Номера от порядка не зависят и не меняются: по номеру игрок
...
const STICKERS: readonly { id: string; glyph: string; art?: string }[] = [
  ...
  /*
   * Второй завоз. Номера начинаются с сотни, а не продолжают первый
   * десяток: `s24`…`s46` носили смайлы прежнего каталога, и хотя за них
   * возвращены жетоны, повторно занимать эти номера незачем — на старой
   * базе они могли бы совпасть с чужой давней покупкой.
   */
  // Небо: то, что видно с башни.
  { id: 's100', glyph: '❄️', art: 'snezhinka.svg' },
  { id: 's101', glyph: '🌧️', art: 'kaplia-dozhdia.svg' },
  { id: 's102', glyph: '⭐️', art: 'zvezda.svg' },
  { id: 's103', glyph: '☄️', art: 'kometa.svg' },
  { id: 's104', glyph: '💨', art: 'veter.svg' },
  { id: 's105', glyph: '💎', art: 'kristall.svg' },
  // Ещё вещи из чужого чемодана.
  { id: 's106', glyph: '🗝️', art: 'kliuch.svg' },
  { id: 's107', glyph: '🕯️', art: 'svecha.svg' },
  { id: 's108', glyph: '📖', art: 'kniga.svg' },
  { id: 's109', glyph: '⚗️', art: 'zelie.svg' },
  { id: 's110', glyph: '🪙', art: 'moneta.svg' },
  { id: 's111', glyph: '🪶', art: 'pero.svg' },
  // Кто ещё водится в подземелье.
  { id: 's112', glyph: '🧟', art: 'zombi.svg' },
  { id: 's113', glyph: '👁️', art: 'glaz.svg' },
  { id: 's114', glyph: '🕷️', art: 'pauk.svg' },
  { id: 's115', glyph: '🧻', art: 'mumiia.svg' },
  { id: 's116', glyph: '🎃', art: 'tykva.svg' },
  { id: 's117', glyph: '🍄', art: 'poganka.svg' },
  // И ещё милые.
  { id: 's118', glyph: '🐻', art: 'medvezhonok.svg' },
  { id: 's119', glyph: '🦔', art: 'iozhik.svg' },
  { id: 's120', glyph: '🐧', art: 'pingvin.svg' },
  { id: 's121', glyph: '🦋', art: 'babochka.svg' },
  { id: 's122', glyph: '🐟', art: 'rybka.svg' },
  { id: 's123', glyph: '🌵', art: 'kaktus.svg' },
];
