...
/**
 * Длительность дуэли, сек. Три минуты — столько же, сколько в спринте:
 * полторы минуты в заказах кончались раньше, чем успевал сложиться расклад,
 * и матч решался тем, кому раньше повезло с пятном.
 */
export const DUEL_SECONDS = 180;
