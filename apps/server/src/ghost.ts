...
/**
 * Корпус «Эталона»: клички под стать образцовому прибору — Т3000, МАШИНА,
 * АГРЕГАТ. Своего выбора у него нет и быть не может, поэтому набор задан
 * здесь намертво; проверяет его тест, а не сервер.
 */
const SYNTHETIC_MARKS: (string | null)[] = ['p24', 'p25', 'p26'];
